package info.rajmundstaniek.gui;

import info.rajmundstaniek.Main;
import info.rajmundstaniek.core.control.Drawable;
...
public class SplashScreen {
    ...
    public static void viewSplashScreen(int durationMillis, Style styleOpen, Style styleClose) {
        ...
        img.setImage(new Image(Drawable.Drawables.SPLASH_SCR.getPath()));
        imgView = img;
